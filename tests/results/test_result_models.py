...
class TestResultService:
    ...
    def test_result_should_be_linked_to_correct_submission(
        self, result, submission
    ):
        assert result.submission == submission

    def test_result_should_be_linked_to_correct_test_case(
        self, result, test_case
    ):
    ...
    def test_submission_related_manager_should_access_results(
