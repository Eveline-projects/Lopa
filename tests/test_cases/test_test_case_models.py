...
class TestTestCaseService:
    ...
    def test_test_cases_should_be_linked_to_correct_problem(self, test_case, problem):
    ...
    def test_test_cases_should_store_expected_output_correctly(self, test_case):
    ...
    def test_problem_related_manager_should_return_all_associated_test_cases(self, problem, test_case):
