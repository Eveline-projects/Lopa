...
class TestSubmissionModel:
    ...
    def test_submission_should_be_linked_to_correct_problem(self, submission, problem):
    ...
    def test_submission_should_have_pending_status_by_default(self, submission):
